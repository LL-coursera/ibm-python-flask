...
def search_transaction():
    ...
    if request.method == 'POST':
        ...
        min_amount = float(request.form['min_amount'])# Get the 'amount' field value from the form and convert it to a float
        max_amount = float(request.form['max_amount'])# Get the 'amount' field value from the form and convert it to a float
        # filter the data
